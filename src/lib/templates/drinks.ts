...
export const DRINK_TEMPLATES: DrinkTemplate[] = [
  ...
  { id: "espresso", category: "warm", icon: "coffee", color: "slate", labels: { ru: "Эспрессо", de: "Espresso" } },
  { id: "americano", category: "warm", icon: "coffee", color: "slate", labels: { ru: "Американо", de: "Americano" } },
  { id: "cappuccino", category: "warm", icon: "coffee", color: "amber", labels: { ru: "Капучино", de: "Cappuccino" } },
  { id: "latte", category: "warm", icon: "coffee", color: "amber", labels: { ru: "Латте", de: "Latte" } },
  { id: "flat-white", category: "warm", icon: "coffee", color: "amber", labels: { ru: "Флэт уайт", de: "Flat White" } },
  { id: "mocha", category: "warm", icon: "coffee", color: "purple", labels: { ru: "Мокка", de: "Mocha" } },
  { id: "macchiato", category: "warm", icon: "coffee", color: "slate", labels: { ru: "Маккиато", de: "Macchiato" } },
  { id: "cortado", category: "warm", icon: "coffee", color: "slate", labels: { ru: "Кортадо", de: "Cortado" } },
  { id: "iced-latte", category: "warm", icon: "coffee", color: "blue", labels: { ru: "Айс латте", de: "Iced Latte" } },
  { id: "raf", category: "warm", icon: "coffee", color: "amber", labels: { ru: "Раф", de: "Raf Coffee" } },
